...
## [20.0.0](https://github.com/Conflux-Chain/revm/compare/revm-precompile-v19.0.0...revm-precompile-v20.0.0) - 2025-05-07
...
- *(isthmus)* Add input size limitations to bls12-381 {G1/G2} MSM + pairing ([#2406](https://github.com/Conflux-Chain/revm/pull/2406))
...
- *(docs)* precompile crate ([#2413](https://github.com/Conflux-Chain/revm/pull/2413))
- bump stable tests, introduce lints ([#2403](https://github.com/Conflux-Chain/revm/pull/2403))
