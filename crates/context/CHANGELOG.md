...
## [4.0.0](https://github.com/Conflux-Chain/revm/compare/revm-context-v3.0.1...revm-context-v4.0.0) - 2025-05-07
...
- Add a custom address to the CreateScheme. ([#2464](https://github.com/Conflux-Chain/revm/pull/2464))
- *(Handler)* merge state validation with deduct_caller ([#2460](https://github.com/Conflux-Chain/revm/pull/2460))
- add chain_ref method to ContextTr trait ([#2450](https://github.com/Conflux-Chain/revm/pull/2450))
...
- cache precompile warming ([#2317](https://github.com/Conflux-Chain/revm/pull/2317))
...
- Remove PrecompileError from PrecompileProvider ([#2233](https://github.com/Conflux-Chain/revm/pull/2233))
- allow reuse of API for calculating initial tx gas for tx ([#2215](https://github.com/Conflux-Chain/revm/pull/2215))
- *(docs)* MyEvm example and book cleanup ([#2218](https://github.com/Conflux-Chain/revm/pull/2218))
- add custom error to context ([#2197](https://github.com/Conflux-Chain/revm/pull/2197))
- Add tx/block to EvmExecution trait ([#2195](https://github.com/Conflux-Chain/revm/pull/2195))
- added with_ref_db fn to Context ([#2164](https://github.com/Conflux-Chain/revm/pull/2164))
- remove specification crate ([#2165](https://github.com/Conflux-Chain/revm/pull/2165))
- make journal entries generic ([#2154](https://github.com/Conflux-Chain/revm/pull/2154))
- Standalone Host, remove default fn from context ([#2147](https://github.com/Conflux-Chain/revm/pull/2147))
- add constructor with hardfork ([#2135](https://github.com/Conflux-Chain/revm/pull/2135))
- implement AccessListTr for Vec ([#2136](https://github.com/Conflux-Chain/revm/pull/2136))
- allow host to be implemented on custom context ([#2112](https://github.com/Conflux-Chain/revm/pull/2112))
- add the debug impl for Evm and EvmData type ([#2126](https://github.com/Conflux-Chain/revm/pull/2126))
...
- Introduce Auth and AccessList traits ([#2079](https://github.com/Conflux-Chain/revm/pull/2079))
- integrate alloy-eips ([#2078](https://github.com/Conflux-Chain/revm/pull/2078))
- *(eip7702)* devnet6 changes and bump eest tests ([#2055](https://github.com/Conflux-Chain/revm/pull/2055))
...
- *(eip7702)* apply latest EIP-7702 changes, backport from v52 ([#1969](https://github.com/Conflux-Chain/revm/pull/1969))
- *(EIP-7623)* Increase calldata cost. backport from rel/v51 ([#1965](https://github.com/Conflux-Chain/revm/pull/1965))
...
- expose precompile address in Journal, DB::Error: StdError ([#1956](https://github.com/Conflux-Chain/revm/pull/1956))
- Make Ctx journal generic ([#1933](https://github.com/Conflux-Chain/revm/pull/1933))
...
- use HashMap::default in LocalContext ([#2451](https://github.com/Conflux-Chain/revm/pull/2451))
- fix typo and update links ([#2387](https://github.com/Conflux-Chain/revm/pull/2387))
- Effective gas price should check tx type ([#2375](https://github.com/Conflux-Chain/revm/pull/2375))
- remove duplicated load_account() ([#2225](https://github.com/Conflux-Chain/revm/pull/2225))
- correct propagate features ([#2177](https://github.com/Conflux-Chain/revm/pull/2177))
- clear JournalState and set first journal vec ([#1929](https://github.com/Conflux-Chain/revm/pull/1929))
- Clear journal ([#1927](https://github.com/Conflux-Chain/revm/pull/1927))
...
- typos ([#2474](https://github.com/Conflux-Chain/revm/pull/2474))
- copy edit The Book ([#2463](https://github.com/Conflux-Chain/revm/pull/2463))
- remove default capacity on journal reverts ([#2449](https://github.com/Conflux-Chain/revm/pull/2449))
- *(journal)* flatten journal entries ([#2440](https://github.com/Conflux-Chain/revm/pull/2440))
- clone_from precompile addresses ([#2438](https://github.com/Conflux-Chain/revm/pull/2438))
...
- make blob params u64 ([#2385](https://github.com/Conflux-Chain/revm/pull/2385))
- set gas_priority_fee to None in TxEnv ([#2371](https://github.com/Conflux-Chain/revm/pull/2371))
- tag v67 revm v21.0.0 ([#2341](https://github.com/Conflux-Chain/revm/pull/2341))
- release-plz ([#2340](https://github.com/Conflux-Chain/revm/pull/2340))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/Conflux-Chain/revm/pull/2299))
...
- remove wrong `&mut` and duplicated spec ([#2276](https://github.com/Conflux-Chain/revm/pull/2276))
- Add custom instruction example ([#2261](https://github.com/Conflux-Chain/revm/pull/2261))
- fix clippy ([#2238](https://github.com/Conflux-Chain/revm/pull/2238))
- use AccessListItem associated type instead of AccessList ([#2214](https://github.com/Conflux-Chain/revm/pull/2214))
...
- pre EIP-7702 does not need to load code ([#2162](https://github.com/Conflux-Chain/revm/pull/2162))
...
- move mainnet builder to handler crate ([#2138](https://github.com/Conflux-Chain/revm/pull/2138))
- fix README link ([#2139](https://github.com/Conflux-Chain/revm/pull/2139))
- remove `optional_gas_refund` as unused ([#2132](https://github.com/Conflux-Chain/revm/pull/2132))
- Adding function derive_tx_type to TxEnv ([#2118](https://github.com/Conflux-Chain/revm/pull/2118))
- fix eofcreate error typo ([#2120](https://github.com/Conflux-Chain/revm/pull/2120))
- remove wrong `&mut`/`TODO`, and avoid useless `get_mut` ([#2111](https://github.com/Conflux-Chain/revm/pull/2111))
- Add docs to revm-bytecode crate ([#2108](https://github.com/Conflux-Chain/revm/pull/2108))
- export eip2930 eip7702 types from one place ([#2097](https://github.com/Conflux-Chain/revm/pull/2097))
- move all dependencies to workspace ([#2092](https://github.com/Conflux-Chain/revm/pull/2092))
- re-export all crates from `revm` ([#2088](https://github.com/Conflux-Chain/revm/pull/2088))
- rm database from context-interface ([#2087](https://github.com/Conflux-Chain/revm/pull/2087))
- tag v57 revm 20.0.0-alpha.1 ([#2086](https://github.com/Conflux-Chain/revm/pull/2086))
- Rename NameTrait to NameTr ([#2084](https://github.com/Conflux-Chain/revm/pull/2084))
- API cleanup ([#2067](https://github.com/Conflux-Chain/revm/pull/2067))
- Add helpers with_inspector with_precompile ([#2063](https://github.com/Conflux-Chain/revm/pull/2063))
- relax halt reason bounds ([#2041](https://github.com/Conflux-Chain/revm/pull/2041))
- simplify some generics ([#2032](https://github.com/Conflux-Chain/revm/pull/2032))
- Add helper functions for JournalInit #1879 ([#1961](https://github.com/Conflux-Chain/revm/pull/1961))
- fix journal naming for inc/dec balance ([#1976](https://github.com/Conflux-Chain/revm/pull/1976))
- Make inspector use generics, rm associated types ([#1934](https://github.com/Conflux-Chain/revm/pull/1934))
