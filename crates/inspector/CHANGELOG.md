...
## [4.0.0](https://github.com/Conflux-Chain/revm/compare/revm-inspector-v3.0.1...revm-inspector-v4.0.0) - 2025-05-07
...
- simplify InspectorContext ([#2036](https://github.com/Conflux-Chain/revm/pull/2036))
...
- *(inspector)* call frame_end after frame_start returns Some ([#2481](https://github.com/Conflux-Chain/revm/pull/2481))
- *(inspector)* fix call return with Some ([#2469](https://github.com/Conflux-Chain/revm/pull/2469))
- *(tracing)* Fix the ordering of EOFCREATE frame traces ([#2398](https://github.com/Conflux-Chain/revm/pull/2398))
- fix typo and update links ([#2387](https://github.com/Conflux-Chain/revm/pull/2387))
- remove wrong Clone Macro in WrapDatabaseRef ([#2181](https://github.com/Conflux-Chain/revm/pull/2181))
...
- inspector when returning right away ([#2089](https://github.com/Conflux-Chain/revm/pull/2089))
- *(tracer)* Flush buffer ([#2080](https://github.com/Conflux-Chain/revm/pull/2080))
...
- remove unused generics from TracerEip3155 ([#2090](https://github.com/Conflux-Chain/revm/pull/2090))
...
- add depth to GasInspector ([#1922](https://github.com/Conflux-Chain/revm/pull/1922))
- Simplify GasInspector ([#1919](https://github.com/Conflux-Chain/revm/pull/1919))
