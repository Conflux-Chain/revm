...
## [4.0.0](https://github.com/Conflux-Chain/revm/compare/revm-bytecode-v3.0.0...revm-bytecode-v4.0.0) - 2025-05-07

### Added

- *(EOF)* Changes needed for devnet-1 ([#2377](https://github.com/Conflux-Chain/revm/pull/2377))
- *(bytecode)* improve legacy bytecode padding ([#2423](https://github.com/Conflux-Chain/revm/pull/2423))
...
- simplify opcode iter ([#2458](https://github.com/Conflux-Chain/revm/pull/2458))
- make OPCODE_INFO a static ([#2459](https://github.com/Conflux-Chain/revm/pull/2459))
- simplify reading signed integers ([#2456](https://github.com/Conflux-Chain/revm/pull/2456))
- cache and use JumpTable::default ([#2439](https://github.com/Conflux-Chain/revm/pull/2439))
