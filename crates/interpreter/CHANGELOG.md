...
## [19.0.0](https://github.com/Conflux-Chain/revm/compare/revm-interpreter-v18.0.0...revm-interpreter-v19.0.0) - 2025-05-07
...
- make ReturnDataImpl and LoopControlImpl public ([#2470](https://github.com/Conflux-Chain/revm/pull/2470))
- copy edit The Book ([#2463](https://github.com/Conflux-Chain/revm/pull/2463))
- Replace InterpreterAction with InterpreterTypes::Output ([#2424](https://github.com/Conflux-Chain/revm/pull/2424))
- simplify reading signed integers ([#2456](https://github.com/Conflux-Chain/revm/pull/2456))
- *(revm-interpreter)* remove unused deps ([#2447](https://github.com/Conflux-Chain/revm/pull/2447))
