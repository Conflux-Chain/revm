...
pub const fn instruction_table<WIRE: InterpreterTypes, H: Host + ?Sized>(
    ...
    table[LOG0 as usize] = host::log::<0>;
    table[LOG1 as usize] = host::log::<1>;
    table[LOG2 as usize] = host::log::<2>;
    table[LOG3 as usize] = host::log::<3>;
    table[LOG4 as usize] = host::log::<4>;
    ...
    table[CREATE as usize] = contract::create::<_, false>;
    ...
    table[CREATE2 as usize] = contract::create::<_, true>;
...
mod tests {
    ...
    fn all_instructions_and_opcodes_used() {
        ...
        let instr_table = instruction_table::<EthInterpreter>();
